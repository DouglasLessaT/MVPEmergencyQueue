package com.DouglasLessa.EmergencyQueueApi.config.handelrs;
...
import com.DouglasLessa.EmergencyQueueApi.annotations.ValidaAcesso;
import com.DouglasLessa.EmergencyQueueApi.model.security.User;
import com.DouglasLessa.EmergencyQueueApi.services.security.UserService;
import com.DouglasLessa.EmergencyQueueApi.util.JWTUtil;
...
public class LoginInterceptor implements HandlerInterceptor {
  ...
  public boolean validaAutorizacao(HttpServletRequest request, HttpServletResponse response, Object handler)
    ...
    System.out.println("Validando acesso para o caminho: " + path);
